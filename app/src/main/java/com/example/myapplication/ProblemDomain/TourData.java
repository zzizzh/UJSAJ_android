...
public class TourData implements Serializable{
    ...
    public Location toLocation(TourData data){
        Location location = new Location();

        location.title = data.getTitle();
        location.bigLocation = data.getBigLocation();
        location.midLocation = data.getMidLocation();
        location.smallLocation = data.getSmallLocation();
        location.contentID = data.getContentid();
        location.contentTypeID = data.getContenttypeid();
